###########################################
#A Walkthrough of implmenting W-NOMINATE for Delegates to the Constitutional Convention of 1787
#
#by David A. Gelman
#Originally coded on 08/22/2016 and updated on 09/21/2016
###########################################
###########################################
...
#From ``Ideology and Participation at the Constitutional Convention of 1787"
#making the final product: 2 plots, both of 1dim NOMINATE from Wilson and Gerry as anchors

##########################################
##########################################
#just using steps already outlined above For Wilson and Gerry
...
Wilson_plot<- Wilson_plot+ theme_bw() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  xlab("Delegate") + ylab("W-NOMINATE Score")
Wilson_plot<-Wilson_plot+ geom_hline(aes(y=0), linewidth=2, linetype="dashed", colour="gray40")
Wilson_plot
ggsave("Wilson1DimPlot.pdf")
...
Gerry_plot<- Gerry_plot+ theme_bw() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  xlab("Delegate") + ylab("W-NOMINATE Score")
Gerry_plot<-Gerry_plot+ geom_hline(aes(y=0), linewidth=2, linetype="dashed", colour="gray40")
Gerry_plot
ggsave("Gerry1DimPlot.pdf")
